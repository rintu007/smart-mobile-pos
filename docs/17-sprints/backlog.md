...
**Total: 20 person-days** (18.5 across items 1–11, plus item 12's 1.5, added 2026-08-02 — see
Change Log) — at the top edge of [roadmap.md](../16-milestones/roadmap.md)'s 15–20 person-day
estimate for M0, not comfortably inside it as the original 18.5 figure was. The gap that produced
item 12 (mobile sign-in was never decomposed despite item 11 depending on it) was a real omission,
not a padding choice, so the honest move is reporting the higher total rather than quietly
absorbing it into an existing item's estimate.
