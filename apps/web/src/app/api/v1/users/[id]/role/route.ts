...
import { changeRole } from "@/modules/roles/service";
import { changeRoleRequestSchema } from "@/modules/roles/schema";
...
export async function PATCH(
  ...
  try {
    ...
    const result = await changeRole(authUserId, tenantId, id, parsed.data);
